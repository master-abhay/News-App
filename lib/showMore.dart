...
class ShowMore extends StatefulWidget {
  const ShowMore({super.key, required this.showMore});
...
class _ShowMoreState extends State<ShowMore> {
  ...
  Future<void> getNewsByQuery(String query, String showMore) async {
    // String url = "https://newsapi.org/v2/top-headlines?country=in&category=$category&apiKey=61dac02ee57c4f6f94b3f7cd0c67e291";
    String url =
        "https://newsapi.org/v2/everything?q=$showMore&sortBy=publishedAt&apiKey=61dac02ee57c4f6f94b3f7cd0c67e291";
  ...
  void initState() {
    ...
    super.initState();
    getNewsByQuery("in", widget.showMore);
  }
